...
function HomeMidSection() {
      const contentArray = [
        ...
        },
        {
            "id":2,
            "img":Two,
            "content":"Consistency - the key to create familiarity  Be it for brands or for user flow"
        },
        {
            "id":3,
            "img":Three,
            "content":"User is the King! Know them - Involve them - Learn from them - Repeat!"
        },
        {
            "id":4,
            "img":Four,
        ...
        },
        {
            "id":5,
            "img":Five,
            "content":"Clean Structure and Hierarchy No more spiraling down the decision paradox!"
        },
      ]
        ...
        <div className='hm-mid-Sec'>
            <div className='hm-midSecDiv'>
                ...
                <div className='hm-mid-text'>
                    <p>Transforming your vision into stunning reality by Unlocking creativity <br />& delivering excellence in my design.</p>
                </div>
            ...
            <div className='hm-midSecDiv'>
                <div className='hm-numSecDiv'>
                    {contentArray.map((item,id)=>{
                       return(
                         <div className={item?.id%2===0?"hm-numSecprntDiv2":"hm-numSecprntDiv1"}>
